...
//#include "ui_scrollareauserlist.h"
...
//    delete item->widget();
//    item = mVBoxLayoutUserList->takeAt(0);
//    delete item->widget();
//    item = mVBoxLayoutUserList->takeAt(0);
//    delete item->widget();
...
void QScrollAreaUserList::buildUserList() const
{
    for (int i=0; i<5; ++i)
    {
        QIcon icon(QIcon("/home/quantity123/QTWorkspace/quantity123/AnyTalk/AnyTalkCli/AnyTalkHeadPortraitIcon/4kong.com-0001.png"));
